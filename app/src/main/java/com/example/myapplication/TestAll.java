...
public class TestAll {
    ...
    public void test(TextView logView){
        ...
        Log.w("pubk->",""+keyPairInfo.getPubk());
        Log.w("prik->",""+keyPairInfo.getPrik());
        result.append("pubk->" + keyPairInfo.getPubk() + "\n");
        result.append("prik->" + keyPairInfo.getPrik() + "\n");
        ...
        result.append("test_sm2_encrypt->" + new String(encText) + "\n");
        ...
        Log.w("test_sm2_decrypt->",new String(data));
        result.append("test_sm2_decrypt->" + new String(data) + "\n");
        ...
        Log.w("test_sm3->",sm3Data);
        result.append("test_sm3->" + sm3Data + "\n");
        ...
        Log.w("test_sm4_encrypt->",sm4EncData);
        result.append("test_sm4_encrypt->" + sm4EncData + "\n");
        ...
        Log.w("test_sm4_decrypt->",new String(sm4DecData));
        result.append("test_sm4_decrypt->" + new String(sm4DecData) + "\n");
        ...
        Log.w("test_md5_encrypt->",md5Data);
        result.append("test_md5_encrypt->" + md5Data + "\n");
        ...
        Log.w("test_hex_encrypt->",hexEncData);
        result.append("test_hex_encrypt->" + hexEncData + "\n");
        ...
        Log.w("test_hex_decrypt->",new String(hexDecData));
        result.append("test_hex_decrypt->" + new String(hexDecData) + "\n");
        ...
        Log.w("test_base64_encrypt->",base64Encode);
        result.append("test_base64_encrypt->" + base64Encode + "\n");
        ...
        Log.w("test_base64_encrypt->",new String(base64Decode));
        result.append("test_base64_encrypt->" + new String(base64Decode) + "\n");

        if (logView != null) {
            logView.setText(result.toString());
        }
